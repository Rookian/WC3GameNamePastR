...
namespace WC3GameNamePastR.String2VK
{
    public static class String2VK
    {
        ...
        private static void SendKey(Win32.VirtualKeys key, KeyState keyState, bool extended = false)
        {
            SendKey((byte)key, keyState, extended);
        }

        private static void SendKey(byte key, KeyState keyState, bool extended = false)
        {
            uint flags = 0;
